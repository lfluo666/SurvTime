...
// NRrepeat
List NRrepeat(int N, int knot, arma::colvec& facility, arma::colvec& delta, arma::mat& z, arma::mat& b_spline, arma::mat& theta, int number_facility, int M_stop, double rate);
RcppExport SEXP _SurvTime_NRrepeat(SEXP NSEXP, SEXP knotSEXP, SEXP facilitySEXP, SEXP deltaSEXP, SEXP zSEXP, SEXP b_splineSEXP, SEXP thetaSEXP, SEXP number_facilitySEXP, SEXP M_stopSEXP, SEXP rateSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type rate(rateSEXP);
    rcpp_result_gen = Rcpp::wrap(NRrepeat(N, knot, facility, delta, z, b_spline, theta, number_facility, M_stop, rate));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_SurvTime_NRrepeat", (DL_FUNC) &_SurvTime_NRrepeat, 10},
    {NULL, NULL, 0}
};
